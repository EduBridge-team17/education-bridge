...
const SelectionStep = ({
  ...
  const levels = [
    {
      id: 'SS 1',
      name: 'SS 1',
      sub: 'Senior Secondary 1',
      icon: <BookText className='text-blue-500' size={36} />,
      bg: 'bg-blue-50',
    },
    {
      id: 'SS 2',
      name: 'SS 2',
      sub: 'Senior Secondary 2',
      icon: <FlaskConical className='text-success-500' size={36} />,
      bg: 'bg-success-50',
    },
    {
      id: 'SS 3',
      name: 'SS 3',
      sub: 'Senior Secondary 3',
      icon: <GraduationCap className='text-secondary-700' size={36} />,
      bg: 'bg-secondary-100',
    },
  ];
  ...
  const subjects = [
    ...
    {
      name: 'Chemistry',
      icon: <FlaskConical size={20} className='text-success-500' />,
    },
    { name: 'Biology', icon: <Leaf size={20} className='text-success-600' /> },
    {
      name: 'Economics',
      icon: <LineChart size={20} className='text-secondary-600' />,
    },
    {
      name: 'Geography',
      icon: <Globe2 size={20} className='text-secondary-700' />,
    },
    { name: 'Civics', icon: <Users2 size={20} className='text-indigo-600' /> },
    { name: 'Agric Sci.', icon: <Leaf size={20} className='text-lime-600' /> },
    {
      name: 'Literature',
      icon: <History size={20} className='text-pink-500' />,
    },
  ];
    ...
    <div className='max-w-4xl mx-auto animate-in fade-in duration-500 font-secondary'>
      <div className='mb-12'>
        <div className='flex justify-between items-center mb-3'>
          <span className='text-h5 font-bold text-primary-800'>
            Step 1: Selection
          </span>
      ...
      <section className='mb-14'>
        <div className='flex items-center gap-3 mb-8'>
          <div className='w-7 h-7 bg-primary-50 text-primary-800 rounded-full flex items-center justify-center text-footer2 font-bold'>
            1
          </div>
          <h2 className='text-h4 font-bold text-neutral-3000'>
            Select Class Level
          </h2>
        </div>
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-8'>
          {levels.map((lvl) => (
            ...
            >
              <div className={`p-6 rounded-lg ${lvl.bg}`}>{lvl.icon}</div>
              <div>
                <p className='text-h1 font-black text-neutral-3000 tracking-tight'>
                  {lvl.id}
                </p>
                <p className='text-footer2 text-neutral-1000 font-medium uppercase tracking-widest mt-1'>
                  {lvl.sub}
                </p>
              </div>
            </div>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5'>
          {subjects.map((sub) => (
            ...
            >
              ...
              <span className='text-h6 font-semibold text-neutral-2000'>
                {sub.name}
              </span>
            </div>
          ))}
