...
import {
  ...
  Zap, Leaf, LineChart, Globe2, Users2, History, Upload, X,
  FileText, Check, Menu
} from 'lucide-react';
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-8 sm:mb-12">
              <div className="flex justify-between items-center mb-3">
                <span className="text-[13px] font-bold text-[#0D685E]">Step 2: Create Lesson</span>
                <span className="text-[13px] font-medium text-gray-400">2 of 3</span>
              </div>
            ...
            {success ? (
              <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-2">Lesson Created!</h2>
                <p className="text-gray-600 mb-4">Redirecting to dashboard...</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-md p-6 space-y-6 border border-gray-200">
                {/* Resource Title */}
                <div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mb-2">
                    Paste your lesson notes, explanations, or study guide content here...
                  </p>
                  <textarea
                    value={content}
